...
class MisReportesPage extends StatefulWidget {
  const MisReportesPage({
    super.key,
    MisReportesDatasource? datasource,
  }) : datasource = datasource ?? const _MisReportesDatasourceFactory();

  final MisReportesDatasource datasource;

  @override
  State<MisReportesPage> createState() => _MisReportesPageState();
}

class _MisReportesDatasourceFactory implements MisReportesDatasource {
  const _MisReportesDatasourceFactory();
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: AppColors.hurtoAtraco.withValues(alpha: 0.08),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(ctx);
              try {
                await widget.datasource.solicitarEliminacionReporte(
                  r['id'] as int,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Cuando registres un incidente, aparecerá aquí.',
